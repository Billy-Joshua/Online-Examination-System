			...
			<footer class="main-footer">
				...
				<!-- Default to the left -->
				<strong>&copy; <?php echo date('Y')?> - Developed by <a href="https://www.linkedin.com/in/ishimwe-billy-joshua-ba4195288/">Ishimwe Billy Joshua</a>. All rights reserved . </strong> All rights reserved
			</footer>
